...
int main() {
   ...
   supprimerEnTete(liste2Ptr, FORWARD) == LISTE_VIDE ? printf("reussi") :
   printf("erreur");

   printf("\nSupression en queue d'une liste vide: ");
   supprimerEnQueue(liste2Ptr, FORWARD) == LISTE_VIDE ? printf("reussi") :
   printf("erreur");

   printf("\n\nSupression selon critere d'une liste vide: \n");
   printf("avant : ");
   afficher(liste2Ptr, FORWARD);
   supprimerSelonCritere(liste2Ptr, FORWARD);
   printf("apres : ");
   afficher(liste2Ptr, FORWARD);
